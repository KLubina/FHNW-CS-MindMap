...
window.StudienplanModule = {
  ...
  // Liefert einen relativen Pfad zur Mindmap-Datei, falls eine bekannte Zuordnung existiert.
  // Pfade sind relativ zur Seite `study-visualization/standard/studienplan-template.html`.
  getMindmapHref(moduleName) {
    const map = {
      "Programmieren 1": "mind-maps 1.sem/programmieren1.html",
      Informationssysteme: "mind-maps 1.sem/informationssysteme.html",
      "Mathematische Grundlagen der Informatik":
        "mind-maps 1.sem/MathGrund.html",
      "Software Engineering Fundamentals": "mind-maps 1.sem/swe-fund.html",
      "User Centered Design and Requirements Engineering":
        "mind-maps 1.sem/UI.html",
      "Programmieren 2": "mind-maps 2.sem/programmieren2.html",
      "System Engineering": "mind-maps 2.sem/sysEng.html",
    };

    const rel = map[moduleName];
    if (!rel) return "";

    // studienplan-template.html liegt in study-visualization/standard/,
    // daher gehen wir zwei Ebenen hoch zum Repo-Root.
    return `../../${rel}`;
  },
